...
import com.example.GoAutoCamping.adapter.Map_RecyclerAdapter;
import com.example.GoAutoCamping.view.dialog.Map_filterdialog;
import com.example.GoAutoCamping.data.Map_placedata;
import com.example.GoAutoCamping.view.dialog.Map_searchDialog;
...
public class MapFragment extends Fragment implements Map_filterdialog.InputSelected, OnMapReadyCallback {
    ...
    private void initializeCardView() {
        ...
        listBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (placedata == null || placedata.isEmpty() || placedata.size() == 0) {
                    ...
                    mapFlag = 1;
                    sView.getMapAsync(MapFragment.this::onMapReady);
                    totBsState(true);
                }
            }
        });
        ...
        searchMidBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fabVisibility(true);
                mapFlag = 2;
                sView.getMapAsync(MapFragment.this);
                sear.clearAnimation();
    ...
    private void settingFab() {
        ...
        filterFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mainFab.bringToFront();
                fabListener(openFlag);
                dlg.setTargetFragment(MapFragment.this, 1);
