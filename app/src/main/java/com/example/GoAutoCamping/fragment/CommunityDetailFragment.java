...
import com.example.GoAutoCamping.view.dialog.CommunityDeclearDialogFragment;
import com.example.GoAutoCamping.view.dialog.CommunityDetailOptionDialogFragment;
...
import com.example.GoAutoCamping.adapter.CommentAdapter;
import com.example.GoAutoCamping.data.CommentDTO;
...
public class CommunityDetailFragment extends Fragment implements CommunityDeclearDialogFragment.Cleared {
    ...
    //포지션값 전달받음
    public CommunityDetailFragment(int position) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnOption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CommunityDetailOptionDialogFragment bottomSheetDialog = CommunityDetailOptionDialogFragment.getInstance();
