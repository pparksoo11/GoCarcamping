...
import com.example.GoAutoCamping.data.Map_placesChoiceData;
import com.example.GoAutoCamping.R;
import com.example.GoAutoCamping.adapter.Community_add_placesChoiceAdapter;
...
public class CommunityAddPlacesChoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(CommunityAddPlacesChoiceActivity.this);
    ...
    public void sendIntent(String add, String ttitle, float latitude, float longitude){
        ...
        Intent inIntent = new Intent(CommunityAddPlacesChoiceActivity.this, CommunityAddActivity.class);
